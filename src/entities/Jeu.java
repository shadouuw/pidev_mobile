 ...
 public String getSource() {
    ...
    public Jeu(int id, String titre, String description, int cours, String diff,String source) {
        ...
        this.source=source;
             ...
             public Jeu(String titre, String description, int cours, String diff,String topscore,String source) {
    ...
    public String toString() {
        return "Jeu{" + "cours=" + cours + ", titre=" + titre + ", description=" + description + ", topscore=" + topscore + ", diff=" + diff + ", source=" + source + '}';
    }
